            ...
            <section className="wrapper">
                ...
                >
                    ...
                    <p className="text-base sm:text-lg text-[#12110c] md:text-xl lg:text-xl book-font w-full sm:w-4/5 md:w-3/4 lg:w-2/3 mx-auto text-center">
                        From SEO and social media management to PPC advertising
                        and content strategy, we craft tailored campaigns that
                        drive traffic, engage your audience, and boost
                        conversions. Let us help your brand stand out in a
